...
public class C10_Sort_Reverse {
    public static void main(String[] args) {
        ...
        ArrayList<String>listCity = new ArrayList<>(List.of("Münih" , "LosAngeles" , "Londra" , "Paris"));
        Collections.reverse(listCity);
        System.out.println(listCity); // [Paris, Londra, LosAngeles, Münih]
