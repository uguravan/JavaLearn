...
bilet gidis donus alinirrsa 20% indirim uygulayan bi app create ediniz
    ...
    public static void main(String[] args) {
        ...
        System.out.println("hangi şehre gideceksiniz : ");
        String city = sc.next().toUpperCase();
        System.out.println("yaşınızı giriniz : ");
        int age = sc.nextInt();
        System.out.println("gidiş-dönüş bilet almak ister misiniz: <E>vet ya da <H>ayır : ");
        char gd = sc.nextLine().trim().charAt(0);
    ...
    private static void ticket(String city, int age, char gd) {
        switch (city) {
            case "B" : ticketToB(age, gd); break;
            case "C" : ticketToC(age, gd); break;
            case "D" : ticketToD(age, gd); break;
            default :
                System.out.println("hatalı giriş girdiniz");
        }
    }

    private static void ticketToB(int age, char gd) {
        if (age >= 0 && age <12){}
    }

    private static void ticketToC(int age, char gd) {

    }

    private static void ticketToD(int age, char gd) {
