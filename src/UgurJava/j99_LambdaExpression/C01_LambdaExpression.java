...
public class C01_LambdaExpression {
    ...
    public static void main(String[] args) {
        ...
        sayi.stream().filter(t -> t%2 == 0).forEach(t -> System.out.print(t + " "));
        System.out.println();
        sayi.stream().filter(C01_LambdaExpression::ciftMi).forEach(C01_LambdaExpression::yazdir);
        System.out.println();

        sayi.stream().filter(t -> t<35).filter(t -> t%2 == 0).forEach(t -> System.out.print(t + " "));
        System.out.println();
        sayi.stream().filter(C01_LambdaExpression::ciftMi).filter(C01_LambdaExpression::denKucuk).forEach(C01_LambdaExpression::yazdir);
        System.out.println();
    ...
    public static boolean denKucuk(int X) {
