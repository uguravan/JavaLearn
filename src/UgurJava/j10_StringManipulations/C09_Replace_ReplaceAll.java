package UgurJava.j10_StringManipulations;
...
// replaceAll() method u replace() methoduna benzer ama 2 fark vardır
        ...
        String isim = "Cigdem Merve";
        String soyad = "Sen";
        long kartNo = 1234567890123456L;
        String kart = String.valueOf(kartNo);
        String yeniIsim = isim.charAt(0) + isim.substring(1, isim.indexOf(" ")).replaceAll("\\w", "*")+" "+isim.charAt(isim.indexOf(" ")+1) + isim.substring(isim.indexOf(" ")+2).replaceAll("\\w", "*");
